...
SAVE_PICKLE = False  # If True, dumps agent and boudary force data into a pickle file for post-processing
...
# If domain is not cubical, N is assigned to the shorter dimension and more agents are added to the longer ones
# +--------------------------------------------------------------------+
N = <ECM_N>
